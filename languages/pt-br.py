...
'Criar Circulo': 'Criar Circulo',
'Criar Poligono': 'Criar Poligono',
...
'Encontrar Localização': 'Encontrar Localização',
'Endereço': 'Endereço',
'Enter a value': 'Enter a value',
'Enter an integer between %(min)g and %(max)g': 'Informe um valor inteiro entre %(min)g e %(max)g',
'Errors': 'Erros',
'Escolha a localização, e em seguida clique no mapa para determinar a área de interesse!': 'Escolha a localização, e em seguida clique no mapa para determinar a área de interesse!',
...
'Raio': 'Raio',
'Raio de Atuação': 'Raio de Atuação',
'RAM': 'RAM',
